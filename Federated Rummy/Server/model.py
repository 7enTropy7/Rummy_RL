...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
            fc1_dims=512, fc2_dims=512, chkpt_dir='incoming_ckpts/actors', name=None):
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, alpha, fc1_dims=512, fc2_dims=512,
            chkpt_dir='incoming_ckpts/critics', name=None):
...
class Agent:
    def __init__(self, n_actions, input_dims, gamma=0.99, alpha=0.0003, gae_lambda=0.95,
            policy_clip=0.2, batch_size=64, n_epochs=10, name=None):
        self.gamma = gamma
        ...
        self.name = name
        self.actor = ActorNetwork(n_actions, input_dims, alpha, name=self.name)
        self.critic = CriticNetwork(input_dims, alpha, name=self.name)
